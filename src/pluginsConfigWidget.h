...
class pluginsConfigWidget : public configWidget, private Ui::pluginsConfigWidget {

	Q_OBJECT

public:
	pluginsConfigWidget(eewsadmObject *argEews) ;
...
Q_DECLARE_METATYPE(ns2__PluginData*) ;
